...
<html lang="en">
  ...
  <body>
    <div class="container">
        <div class="col-md-12">
            <h3 style="margin: 20px 0px 20px 0px">Tamabah Data Mahasiswa</h3>
            <form method="post" action="tambah_aksi.php" class="form_horizontal">
                ...
                <div class="form-check">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Pemrograman Web">
                        <label class="form-check-label">
                        Pemrograman Web
                        </label>
                    </div>
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Analisa Pemrogram SI">
                        <label class="form-check-label">
                        Analisa Pemrogram SI
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Infrastruktur TI">
                        <label class="form-check-label">
                        Infrastruktur TI
                        </label>
                     </div>
