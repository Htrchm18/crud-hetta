    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <form method="post" action="edit_aksi.php" class="form_horizontal">
                ...
                <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Data Base" <?php if(in_array("Data Base",$checked)) echo "checked" ?>>
                        <label class="form-check-label">
                        Data Base
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Pemrograman Web" <?php if(in_array("Pemrograman Web",$checked)) echo "checked" ?>>
                        <label class="form-check-label">
                        Pemrograman Web
                        </label>
                    </div>
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Analisa Pemrogram SI" <?php if(in_array("Analisa Pemrograman SI",$checked)) echo "checked" ?>>
                        <label class="form-check-label">
                        Analisa Pemrogram SI
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="keahlian[]" value="Infrastruktur TI" <?php if(in_array("Infrastruktur TI",$checked)) echo "checked" ?>>
                        <label class="form-check-label">
                        Infrastruktur TI
                        </label>
                     </div>
